...
const pgnListMessages: N2KMessage[] = [
  {
    ...
    fields: {
      ...
      list: [
        59392, 59904, 60928, 126996, 126464, 127245, 127258, 127488, 127489, 127493, 127498, 127506,
        127508, 128259, 128267, 128275, 129025, 129026, 129029, 129033, 129038, 129039, 129040,
        129041, 129283, 129285, 129539, 129540, 129794, 129798, 129799, 129802, 129808, 130306,
        130312, 130576,
      ].map((pgn) => ({ pgn })),
    },
  },
