...
const pgnListMessages: N2KMessage[] = [
	{
		...
		fields: {
			...
			list: [
				...
				127493, 127498, 127506, 127508, 128259, 128267, 129025, 129026, 129029,
				129038, 129039, 129040, 129041, 129283, 129285, 129539, 129540, 129794,
				129798, 129799, 129802, 129808, 130306, 130312, 130576,
			].map((pgn) => ({ pgn })),
		},
	},
	{
