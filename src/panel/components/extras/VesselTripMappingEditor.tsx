...
import MappingTable, { signalkIdColumn, textColumn } from "./MappingTable";
...
export default function VesselTripMappingEditor({ value, onChange }: Props): React.ReactElement {
